...
log_level = 2
warn_on_root = 1
requirements += sqlite3,kivy.deps.glew,kivy.deps.sdl2,kivy.deps.gstreamer,kivy.deps.angle,kivy.deps.glew_dev,kivy.deps.sdl2_dev,kivy.deps.gstreamer_dev
